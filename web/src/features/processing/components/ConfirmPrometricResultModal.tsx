            ...
            <div className="flex-1">
              {isFailed && (
                <div>
                  ...
                  <p className="text-xs text-rose-600 mt-2">If you confirm, processing for this candidate will stop here and no further steps will be advanced. You can optionally cancel the processing immediately.</p>
                </div>
              )}
