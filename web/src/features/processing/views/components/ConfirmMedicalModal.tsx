        ...
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription className="text-sm text-muted-foreground">This will save the medical result and any provided MOFA number.</DialogDescription>
            </div>
          </DialogTitle>
        </DialogHeader>
            ...
            <div className="flex-1">
              ...
              {isPassed && (
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">The candidate has passed Medical — processing will continue as normal.</p>
                  {mofaNumber && (
                    <div className="mt-3 text-xs text-muted-foreground">MOFA number: <span className="font-medium text-foreground">{mofaNumber}</span></div>
                  )}
              ...
              {isMedicalPassed === null && (
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-2">Please select Passed or Failed before saving the Medical result.</p>
                </div>
              )}
              ...
              {isFailed && (
                <div className="mt-3">
                  <label className="text-xs text-muted-foreground mb-1 block">Notes (required for failed)</label>
                  <Textarea value={notes} onChange={(e) => onNotesChange?.(e.target.value)} rows={4} maxLength={1000} />
