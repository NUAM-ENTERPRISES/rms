...
export const CandidateHistory: React.FC<CandidateHistoryProps> = ({ candidateId }) => {
  return (
    <div className="space-y-6">
      <Card className="border-0 shadow-xl bg-card/90 backdrop-blur-md overflow-hidden rounded-2xl transition-shadow duration-300 hover:shadow-2xl">
        <CardHeader className="border-b border-border pb-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription className="mt-2 text-muted-foreground font-medium max-w-xl">
