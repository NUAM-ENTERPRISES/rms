      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div>
            ...
            <p className="text-sm flex items-center gap-2 mt-1">
              ...
              {(() => {
                ...
                return candidate.totalExperience || candidate.experience || 0;
              })()}
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm mt-1">{formatDate(candidate.createdAt)}</p>
          </div>
          <div>
            <label className="text-xs font-medium text-slate-500 uppercase tracking-wide">
              Last Updated
            </label>
            <p className="text-sm mt-1">{formatDate(candidate.updatedAt)}</p>
          </div>
        </div>
  ...
  <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-xl rounded-2xl overflow-hidden 
    ...
    <CardContent className="p-6 space-y-4 bg-gradient-to-b from-gray-50/50 to-white">
      {[
        ...
        >
          <div className={`absolute inset-0 rounded-xl bg-gradient-to-r ${color} opacity-0 
          ...
          <div className="flex items-center gap-4">
            <div className={`p-2.5 rounded-lg bg-gradient-to-br ${color} shadow-md`}>
              {label === "Applications" && <Send className="h-5 w-5 text-white" />}
              {label === "Interviews" && <CalendarCheck className="h-5 w-5 text-white" />}
              {label === "Offers" && <Handshake className="h-5 w-5 text-white" />}
              {label === "Placements" && <Trophy className="h-5 w-5 text-white" />}
            </div>
          ...
          <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-transparent via-current to-transparent 
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1 pr-4">
                ...
                <div className="flex items-center gap-3 mt-1 text-sm">
                  ...
                  {qual.university && (
                    <>
                      {qual.qualification.shortName && <span className="text-slate-400">•</span>}
              ...
              <div className="flex flex-wrap items-center gap-5 mt-4 text-sm text-slate-600">
                ...
                {qual.gpa && (
                  <div className="flex items-center gap-2 font-medium">
                    ...
                    <span className="text-slate-800 font-semibold">GPA: {qual.gpa}</span>
                  </div>
                )}
              </div>
            )}
        ...
        <div className="max-w-sm mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-slate-600">
              Add degrees, certifications, and academic achievements to strengthen this profile.
            </p>
          </div>
          {canWriteCandidates && (
            <Button
      ...
      <div className="py-16 text-center">
        <div className="max-w-sm mx-auto space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-slate-600">
              Showcase past roles, responsibilities, and achievements to stand out.
            </p>
          </div>
          {canWriteCandidates && (
            <Button
        ...
        <div className="py-16 text-center">
          <div className="max-w-md mx-auto space-y-6">
            ...
            <div className="text-sm text-slate-500 space-y-2">
              <p>Assign them to a project to track performance and progress.</p>
            </div>
          </div>
        </div>
      )}
