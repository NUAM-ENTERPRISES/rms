...
export function TrainingCard({ training, onView }: TrainingCardProps) {
  const candidate = training.mockInterview?.candidateProjectMap?.candidate;
  const project = training.mockInterview?.candidateProjectMap?.project;
  const role = training.mockInterview?.candidateProjectMap?.roleNeeded;
