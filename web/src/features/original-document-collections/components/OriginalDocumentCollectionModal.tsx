...
export function OriginalDocumentCollectionModal({
  ...
  return (
    ...
    >
      <DialogContent
        className={cn(
          "!flex h-[min(65vh,600px)] max-h-[65vh] w-[min(96vw,1100px)] !max-w-[min(96vw,1100px)] flex-col gap-0 overflow-hidden rounded-xl border border-border/80 bg-card p-0 shadow-2xl",
          className,
        )}
      >
        <DialogHeader className="shrink-0 space-y-0 border-b border-border/80 bg-gradient-to-r from-teal-50/60 via-card to-slate-50 px-5 py-4 text-left">
