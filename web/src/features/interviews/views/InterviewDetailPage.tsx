    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-950">
      ...
      <ScrollArea className="h-[calc(100vh-65px)]">
        <div className="w-full px-6 py-8 space-y-8">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-5">
                  <ImageViewer
                    ...
                    className="h-20 w-20 rounded-2xl border-4 border-white shadow"
                  />
            ...
            <Card className="border border-zinc-200 shadow-sm">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="text-lg font-semibold text-black">Project & Role</h3>
                </div>
          ...
          <Card className="border border-zinc-200 shadow-sm">
            <CardContent className="p-6">
              <h3 className="text-lg font-semibold text-black mb-6">Interview Information</h3>
              ...
              {/* Meeting Link with WhatsApp Button on Right */}
