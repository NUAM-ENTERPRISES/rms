...
export default function AssignedInterviewsListPage() {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-slate-50 via-white to-indigo-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20 dark:text-white">
      {/* Compact Header */}
      <header className="border-b bg-white/95 backdrop-blur-xl shadow-sm sticky top-0 z-20 dark:bg-slate-800/95 dark:border-slate-700">
          ...
          <div className="flex items-center gap-3 mt-3">
            <div className="relative flex-1 max-w-md group">
              ...
              <Input
                ...
                className="pl-10 h-9 text-sm rounded-xl border-indigo-200/50 bg-white/90 shadow-inner hover:shadow-md focus:shadow-lg transition-all duration-200 focus:ring-1 focus:ring-indigo-400/30 focus:border-indigo-400 dark:bg-slate-700/50 dark:border-slate-600 dark:text-white dark:focus:ring-indigo-400/50"
              />
            </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-80 border-r bg-white/85 backdrop-blur-lg shadow-md overflow-hidden flex flex-col dark:bg-slate-800/85 dark:border-slate-700">
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isSelected
                          ? `${isBatchSelected ? "bg-green-50 dark:bg-green-900" : "bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900 dark:to-purple-900"} border-${isBatchSelected ? "green" : "indigo"}-300/50 shadow-md ring-1 ring-${isBatchSelected ? "green" : "indigo"}-300/30`
                          : "bg-white dark:bg-slate-800 border-slate-200/60 dark:border-slate-700 hover:border-indigo-300 dark:hover:border-indigo-300 hover:shadow-md"
                      )}
                    >
                      <button
                        onClick={(e) => {
       ...
       <div className="flex-1 overflow-hidden bg-gradient-to-b from-white to-indigo-50/30 dark:from-slate-950 dark:to-indigo-950/40">
  {selected ? (
...
>
  ...
  Schedule
        ...
        <Card className="border-0 shadow-lg bg-white/95 backdrop-blur-md dark:bg-slate-900/70 rounded-xl overflow-hidden transition-all hover:shadow-xl">
          <CardContent className="p-5">
    ...
    <div className="h-full flex items-center justify-center text-center bg-gradient-to-b from-white to-indigo-50/30 dark:from-slate-950 dark:to-indigo-950/40">
