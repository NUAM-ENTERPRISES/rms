    ...
    return (
      <div className="p-8">
          <Alert variant="destructive">
            ...
            <AlertDescription>Failed to load assigned screenings. Please try again.</AlertDescription>
          </Alert>
        </div>
    );
  }
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-semibold tracking-tight">Assigned Screenings</h1>
