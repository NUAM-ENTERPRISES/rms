...
export default function TemplatesPage() {
  ...
  const getTemplateCardColor = (
    ...
    const inactiveColors = {
      ...
      iconBg: "bg-slate-50 dark:bg-black/50",
      border: "border-slate-200 dark:border-slate-800",
      questionBadge:
        "bg-slate-50 text-slate-600 border-slate-200 dark:bg-black dark:text-slate-400 dark:border-slate-800",
      roleBadge:
        "bg-slate-50 text-slate-600 border-slate-200 dark:bg-black dark:text-slate-400 dark:border-slate-800",
    };
    return isActive
  ...
  if (error) {
    return (
      <div className="p-8 bg-black">
        <Alert variant="destructive" className="bg-slate-900 border-red-900/50">
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 dark:bg-black">
      <div className="w-full mx-auto space-y-6 mt-2 px-4 sm:px-6 lg:px-8">
        {/* Header */}
<<<<<<< HEAD
...
=======
        <Card className="border-0 shadow-2xl bg-gradient-to-br from-indigo-50/90 to-purple-50/90 dark:from-black dark:to-black rounded-2xl overflow-hidden ring-1 ring-indigo-200/30 dark:ring-slate-800 transition-all duration-300 hover:shadow-3xl hover:ring-indigo-300/50 dark:hover:ring-slate-700">
          <CardHeader className="pb-3 border-b border-indigo-200/50 dark:border-slate-800">
            <div className="flex items-center justify-between w-full">
              <div className="flex items-center gap-4">
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-500 dark:opacity-20 dark:group-hover:opacity-40"></div>
                  <div className="relative p-2.5 bg-gradient-to-br from-indigo-600 to-purple-700 rounded-xl shadow-md transform transition-transform duration-300 group-hover:scale-105 dark:from-indigo-700 dark:to-purple-800">
                    <FileText className="h-6 w-6 text-white drop-shadow-md" />
                  </div>
                </div>
                <div>
                  <CardTitle className="text-2xl font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent tracking-tight">
                    Screening Templates
                  </CardTitle>
...
>>>>>>> copy/dark-theme
              ...
              {canWrite && (
                <Button
                  ...
                  className="relative group overflow-hidden gap-2 h-11 px-6 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 rounded-xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] text-white font-medium text-sm tracking-wide dark:from-indigo-700 dark:via-purple-700 dark:to-pink-700 dark:hover:from-indigo-800 dark:hover:via-purple-800 dark:hover:to-pink-800"
                >
              ...
              <div className="relative group">
                <div
                  className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-all duration-300 ${
                    filters.search ? "text-indigo-600 dark:text-indigo-400 scale-110" : "text-slate-400 dark:text-slate-500"
                  }`}
                >
                ...
                <Input
                  ...
                  className="pl-12 h-12 text-base rounded-xl border-0 bg-white/80 dark:bg-black/90 backdrop-blur-sm shadow-inner hover:shadow-md focus:shadow-lg focus:ring-2 focus:ring-indigo-400/30 focus:border-indigo-400 transition-all duration-300 placeholder:text-slate-400 dark:placeholder:text-slate-500 dark:text-slate-100"
                />
                <div
                  className={`absolute inset-0 rounded-xl pointer-events-none transition-all duration-300 ${
                    filters.search ? "ring-2 ring-indigo-400/20 shadow-lg dark:ring-indigo-500/30" : ""
                  }`}
                />
              </div>
...
=======
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-indigo-500 rounded-full animate-pulse dark:bg-indigo-400"></div>
                  ...
                  >
                    <SelectTrigger className="h-10 px-4 border-0 bg-white/80 dark:bg-black/90 backdrop-blur-sm rounded-xl shadow-inner hover:shadow-md focus:shadow-lg focus:ring-2 focus:ring-indigo-400/30 transition-all duration-300 min-w-[180px] text-sm dark:text-slate-100">
                      <SelectValue placeholder="All Roles" />
                    </SelectTrigger>
                    <SelectContent className="rounded-xl border-0 shadow-2xl bg-white/95 dark:bg-black/95 backdrop-blur-sm max-h-[300px]">
                      <SelectItem value="all" className="rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 dark:text-slate-100 dark:focus:bg-indigo-900/50">
                        All Roles
                      </SelectItem>
                      {roles.map((role) => (
                        <SelectItem key={role.id} value={role.id} className="rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 dark:text-slate-100 dark:focus:bg-indigo-900/50">
                          {role.name}
                        </SelectItem>
                      ))}
                    </SelectContent>
...
>>>>>>> copy/dark-theme
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <SelectTrigger className="h-10 px-4 border-0 bg-white/80 dark:bg-black/90 backdrop-blur-sm rounded-xl shadow-inner hover:shadow-md focus:shadow-lg focus:ring-2 focus:ring-indigo-400/30 transition-all duration-300 min-w-[140px] text-sm dark:text-slate-100">
                      <SelectValue placeholder="All Status" />
                    </SelectTrigger>
                    <SelectContent className="rounded-xl border-0 shadow-2xl bg-white/95 dark:bg-black/95 backdrop-blur-sm">
                      <SelectItem value="all" className="rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 dark:text-slate-100 dark:focus:bg-indigo-900/50">
                        All Status
                      </SelectItem>
                      <SelectItem value="true" className="rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 dark:text-slate-100 dark:focus:bg-indigo-900/50">
                        Active Only
                      </SelectItem>
                      <SelectItem value="false" className="rounded-lg hover:bg-indigo-50 dark:hover:bg-indigo-900/50 dark:text-slate-100 dark:focus:bg-indigo-900/50">
                        Inactive Only
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                {(filters.search || filters.roleId !== "all" || filters.isActive !== "all") && (
                  <Button
                    ...
                    className="h-10 px-4 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-indigo-50/50 dark:hover:bg-indigo-900/30 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 gap-2"
                  >
            ...
            <CardContent className="py-16 px-8">
              <div className="text-center max-w-md mx-auto space-y-6">
                ...
                <div className="relative mx-auto w-20 h-20">
                  {/* Glow background */}
                  <div className="absolute inset-0 bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full blur-3xl opacity-30 animate-pulse-slow dark:opacity-20 dark:from-indigo-500 dark:to-purple-500"></div>
                  
                  {/* Icon container */}
                  <div className="relative w-full h-full rounded-2xl bg-white/90 dark:bg-black/90 backdrop-blur-lg border border-indigo-200/50 dark:border-slate-800 flex items-center justify-center shadow-xl transform transition-transform duration-300 hover:scale-105">
                    <FileText className="h-10 w-10 text-indigo-600 dark:text-indigo-400 drop-shadow-md" />
                  </div>
                </div>
...
=======
                <div className="space-y-3">
                  <h3 className="text-2xl font-extrabold bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 dark:from-indigo-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent tracking-tight">
                    No Templates Found
                  </h3>
                ...
                {canWrite &&
                  ...
                  filters.isActive === "all" && (
                    <Button
                      onClick={handleCreate}
                      size="lg"
                      className="gap-2 h-12 px-8 mt-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] text-base font-medium dark:from-indigo-700 dark:to-purple-700 dark:hover:from-indigo-800 dark:hover:to-purple-800"
                    >
                      <Plus className="h-5 w-5" />
                      Create Template
                    </Button>
...
>>>>>>> copy/dark-theme
              ...
              return (
                <Card key={roleName} className="border-0 shadow-xl bg-gradient-to-br from-white/90 to-indigo-50/50 dark:from-black dark:to-black rounded-2xl overflow-hidden ring-1 ring-indigo-200/30 dark:ring-slate-800 transition-all duration-300 hover:shadow-2xl hover:ring-indigo-300/50 dark:hover:ring-slate-700">
                  <CardHeader className="pb-3 border-b border-indigo-200/50 dark:border-slate-800">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-10 h-10 rounded-xl flex items-center justify-center ${roleColor.iconBg} border border-indigo-200/50 dark:border-slate-800 shadow-sm`}
                        >
                          <BookOpen className={`h-5 w-5 ${roleColor.icon}`} />
                        </div>
                        <div>
                          <CardTitle className="text-lg font-bold bg-gradient-to-r from-indigo-700 to-purple-700 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent tracking-tight">
                            {roleName}
                          </CardTitle>
