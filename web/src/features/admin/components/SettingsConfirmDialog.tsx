    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md border-0 shadow-2xl bg-white dark:bg-slate-900">
        <DialogHeader className="space-y-4 pt-2">
          ...
          <DialogDescription className="text-sm text-center text-slate-600 dark:text-slate-400 leading-relaxed">
            {currentConfig.description}
          </DialogDescription>
        </DialogHeader>

        {type === "save" && (
          <div className="mx-4 p-3 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-900/50 rounded-lg flex items-start gap-3">
        ...
        {type === "edit" && (
          <div className="mx-4 p-3 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900/50 rounded-lg flex items-start gap-3">
        ...
        <DialogFooter className="flex-col sm:flex-row gap-3 mt-4 px-2">
          <Button
            ...
            disabled={isLoading}
            className="flex-1 h-11 border-2 font-medium dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
          >
            Cancel
          </Button>
          <Button
