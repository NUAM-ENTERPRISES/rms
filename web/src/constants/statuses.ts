...
> = {
  [CANDIDATE_STATUS.UNTOUCHED]: {
    ...
    color: "gray",
    badgeClass: "bg-gray-50 dark:bg-gray-900 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-800",
    icon: "User",
    priority: "high",
  },
  [CANDIDATE_STATUS.INTERESTED]: {
    ...
    color: "green",
    badgeClass: "bg-green-50 dark:bg-green-900 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800",
    icon: "ThumbsUp",
    priority: "high",
  },
  [CANDIDATE_STATUS.NOT_INTERESTED]: {
    ...
    color: "red",
    badgeClass: "bg-red-50 dark:bg-red-900 text-red-700 dark:text-red-300 border-red-200 dark:border-red-800",
    icon: "XCircle",
    priority: "low",
  },
  ...
  [CANDIDATE_STATUS.OTHER_ENQUIRY]: {
    ...
    color: "orange",
    badgeClass: "bg-orange-50 dark:bg-orange-900 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-800",
    icon: "MessageCircle",
    priority: "medium",
  },
  [CANDIDATE_STATUS.FUTURE]: {
    ...
    color: "blue",
    badgeClass: "bg-blue-50 dark:bg-blue-900 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800",
    icon: "Clock",
    priority: "low",
  },
  [CANDIDATE_STATUS.ON_HOLD]: {
    ...
    color: "yellow",
    badgeClass: "bg-yellow-50 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800",
    icon: "Pause",
    priority: "medium",
  },
  [CANDIDATE_STATUS.RNR]: {
    ...
    color: "red",
    badgeClass: "bg-red-50 dark:bg-red-900/50 text-red-700 dark:text-red-300 border-red-200 dark:border-red-800",
    icon: "PhoneOff",
    priority: "urgent",
  },
  [CANDIDATE_STATUS.QUALIFIED]: {
    ...
    color: "green",
    badgeClass: "bg-green-50 dark:bg-green-900/50 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800",
    icon: "CheckCircle",
    priority: "high",
  },
  // Legacy statuses
  [CANDIDATE_STATUS.NEW]: {
    ...
    color: "blue",
    badgeClass: "bg-blue-50 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-800",
    icon: "UserPlus",
    priority: "high",
  },
