...
export class TrainingController {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve basic training assignments not linked to a screening. Returns candidate and full project details. Supports pagination and search.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'After training completion, mark candidate ready for another screening',
  })
  @ApiParam({ name: 'id', description: 'Training assignment ID' })
  @ApiResponse({
    status: 200,
