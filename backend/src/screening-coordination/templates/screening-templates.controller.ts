...
import { UpdateScreeningTemplateDto } from './dto/update-template.dto';
import { QueryScreeningTemplatesDto } from './dto/query-templates.dto';
...
@ApiTags('Screening Templates')
@ApiBearerAuth()
@Controller('screening-templates')
export class ScreeningTemplatesController {
  constructor(private readonly templatesService: ScreeningTemplatesService) {}

  @Post()
  @Permissions('write:interview_templates')
  @ApiOperation({
    summary: 'Create a new screening template',
    description:
  ...
  create(@Body() createDto: CreateScreeningTemplateDto) {
  ...
  @ApiOperation({
    summary: 'Get all screening templates',
    description:
  ...
  async findAll(@Query() query: QueryScreeningTemplatesDto) {
  ...
  @ApiOperation({
    ...
    description: 'Retrieve a specific screening template by its ID.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing screening template. Interview Coordinators only.',
  })
  @ApiParam({
    name: 'id',
    description: 'Template ID',
  ...
  update(
    @Param('id') id: string,
    @Body() updateDto: UpdateScreeningTemplateDto,
  ) {
  ...
  @ApiOperation({
    ...
    description:
      'Delete a screening template. Interview Coordinators only.',
  })
  @ApiParam({
    name: 'id',
    description: 'Template ID',
