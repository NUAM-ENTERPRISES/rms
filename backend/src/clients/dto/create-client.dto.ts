...
export class CreateClientDto {
  ...
  @IsEnum(['INDIVIDUAL', 'SUB_AGENCY', 'HEALTHCARE_ORGANIZATION', 'EXTERNAL_SOURCE'])
  type: 'INDIVIDUAL' | 'SUB_AGENCY' | 'HEALTHCARE_ORGANIZATION' | 'EXTERNAL_SOURCE';
  ...
  @ApiPropertyOptional({ description: 'Organization (for individual referrers)' })
  @IsOptional()
  @IsString()
  organization?: string;
  ...
  @ApiPropertyOptional({ description: 'Specialties (for sub-agencies)', type: [String] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  specialties?: string[];
  ...
  @ApiPropertyOptional({ description: 'Locations (for healthcare organizations)', type: [String] })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  locations?: string[];
  ...
  @ApiPropertyOptional({ 
    ...
    enum: ['JOB_BOARD', 'SOCIAL_MEDIA', 'REFERRAL_PLATFORM', 'INDUSTRY_EVENT', 'COLD_OUTREACH', 'OTHER']
  })
  @IsOptional()
  @IsEnum(['JOB_BOARD', 'SOCIAL_MEDIA', 'REFERRAL_PLATFORM', 'INDUSTRY_EVENT', 'COLD_OUTREACH', 'OTHER'])
  sourceType?: 'JOB_BOARD' | 'SOCIAL_MEDIA' | 'REFERRAL_PLATFORM' | 'INDUSTRY_EVENT' | 'COLD_OUTREACH' | 'OTHER';
  ...
  relationshipType?: 'REFERRAL' | 'PARTNERSHIP' | 'DIRECT_CLIENT' | 'EXTERNAL_SOURCE';
