...
export class SystemService {
  ...
  async getSystemConfig(parts: string[] = []): Promise<SystemConfigResponse> {
    ...
    const roleBadgeConfig = {
      ...
      'Recruitment Lead': { variant: 'secondary', priority: 4 },
      'Recruiter Manager': { variant: 'secondary', priority: 4 },
      'Processing Lead': { variant: 'secondary', priority: 4 },
      'Processing Manager': { variant: 'secondary', priority: 4 },
